...
type EventBus struct {
	...
	lock     RecursiveMutex // a lock for the map
	wg       sync.WaitGroup
}
...
type eventHandler struct {
	...
	async          bool
	transactional  bool
	RecursiveMutex // lock for an event handler - useful for running async callbacks serially
}
...
func (bus *EventBus) Subscribe(topic string, fn interface{}) error {
	return bus.doSubscribe(topic, fn, &eventHandler{
		reflect.ValueOf(fn), false, false, false, RecursiveMutex{},
	})
}
...
func (bus *EventBus) SubscribeAsync(topic string, fn interface{}, transactional bool) error {
	return bus.doSubscribe(topic, fn, &eventHandler{
		reflect.ValueOf(fn), false, true, transactional, RecursiveMutex{},
	})
}
...
func (bus *EventBus) SubscribeOnce(topic string, fn interface{}) error {
	return bus.doSubscribe(topic, fn, &eventHandler{
		reflect.ValueOf(fn), true, false, false, RecursiveMutex{},
	})
}
...
func (bus *EventBus) SubscribeOnceAsync(topic string, fn interface{}) error {
	return bus.doSubscribe(topic, fn, &eventHandler{
		reflect.ValueOf(fn), true, true, false, RecursiveMutex{},
	})
}
